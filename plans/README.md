...
(plan only). Flop joins chip’s `PuttStroke` pad; flight stays flop; `FLOP_MAX_YD` 30 is a ceiling not a floor.
...
| `flop-short-dial-phase1.md` | PLAN — flop joins chip pad; 30 yd ceiling only; picker-only |
