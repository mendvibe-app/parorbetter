...
- **Phase 4 640 playtested — revert to 900** (`putt-panel-restore-900.md`). **Do not start Phase 5 polish until that restore ships.**
...
### Phase 4 — Execute-phase camera + screen reclaim — REVERTING

640 failed pace playtest (`plans/recon_putt_pad_height.md`). Restore 900 for
every shot type: `plans/putt-panel-restore-900.md`.
