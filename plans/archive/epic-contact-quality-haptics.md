...
## Status: SHIPPED (code); device QA CLOSED (deferred)

**Closed 2026-08-14** — Android/iOS smoke parked. Reopen after free play if haptics need
re-check. Code/plugins/desktop fallback landed in `0334561`.
